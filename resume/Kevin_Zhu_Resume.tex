...
\textbf{Milliman} --- Property and casualty actuarial consulting\hfill San Francisco, CA \\
...
%	\item Joined several decades of flood insurance policy and claim data, resolving inconsistencies between datasets and determining the optimal set of variables on which to join to minimize missing and duplicate records 
