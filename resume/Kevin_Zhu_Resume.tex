...
\begin{itemize}
	...
	\item Joined several decades flood insurance policy and claim data, resolving inconsistencies between datasets and determining the optimal set of variables on which to join to minimize missing and duplicate records 
