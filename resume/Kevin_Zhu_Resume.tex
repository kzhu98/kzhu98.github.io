...
\begin{itemize}
	\item Estimated rate indication for a transportation network company accounting for over \$100M in gross WP by state, coverage, and period, adjusting loss data and trend selections for coverage changes and COVID impacts
\end{itemize}
\smallspace
