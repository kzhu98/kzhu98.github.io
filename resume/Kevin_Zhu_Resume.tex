...
\begin{itemize}
	...
	\item Designed a policy/claim/coverage level BOP database, including data extracts and reconciliation, allocation of ultimate losses and claim counts using record-level Bornhuetter-Ferguson, and calculation of earned exposures
	\item Supported data extracts and transformations (focusing on loss segmentation and development by peril) for a BOP pure premium XGBoost model %and rebalanced model predictions to actuarial rate indications
