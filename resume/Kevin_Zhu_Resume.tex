...
\begin{itemize}
	\item Realigned medical malpractice, D\&O, and E\&O reserve classes for more granular unpaid claim analyses, splitting aggregate data into homogeneous subsegments and selecting new payment and reporting patterns
	...
	\item Designed new exhibits to better communicate parametric effects of changes in LDF and ELR assumptions
\end{itemize}
...
%	HTML \& CSS, JavaScript, PHP, C++, \LaTeX
	\item \textbf{Other Tools}: Advanced Microsoft Excel, Introductory Microsoft Access
