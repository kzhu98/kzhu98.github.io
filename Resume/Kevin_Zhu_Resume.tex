...
{\fontsize{12pt}{13pt}\selectfont 370 Carmelita Place, Fremont, CA 94539 | kevinzhu98@gmail.com | (510) 497-0570}
\sectspace
...
%	\item Completed quarterly dwelling fire rate indication \inc{and inland marine reserve review}, applying techniques from the CAS Exam 5 texts by Werner, Modlin\inc{, and Friedland}
\end{itemize}
\textbf{UCLA Mathematics Computing Lab}\hfill Los Angeles, CA \\
%\textit{Head Lab Assistant} \hfill Sep 2018 -- Present \\
\textit{PIC Lab Assistant} \hfill Sep 2017 -- Present %Sep 2018
\begin{itemize}
...
%%% Relevant Experience %%%
%\textbf{RELEVANT EXPERIENCE}\sectline
%\textbf{California Actuarial League Ninth Annual Case Competition} \hfill Berkeley, CA \\
%Best Solution (\details{H\&B, P\&C Tracks}{Health \& Benefits; Property \& Casualty}) \hfill Feb 2018 -- Apr 2018 \\
%\begin{itemize}
%	\item Mitigated adverse selection risk in offering standalone health insurance plans as multi-choice options
%	\item Adjusted homeowners' insurance rates, minimizing policy-level premium dislocation 
...
%Finalist (\details{P\&C, Retirement Tracks}{Property \& Casualty; Retirement}); Best Individual Presenter (Retirement) \hfill Mar 2017 -- Apr 2017 \\
%\begin{itemize}
%	\item Recommended risk-reducing actions for a defined-benefit pension plan sponsor
...
%	Advanced \textbf{Microsoft Excel}
%	&
%	Intermediate \textbf{VBA}
%	\\
%	\textbf{Python}, incl. NumPy, SciPy, SymPy, and Pandas
%	&
%	\textbf{PL/SQL} and \textbf{Access SQL} 
%	\\
%	Web Programming (\textbf{HTML, CSS, JavaScript, PHP})
%	&
%	Intermediate \textbf{Tableau}
%	\\
%	Introductory \textbf{Microsoft Access}
%	&
%	Intermediate \textbf{C++}
%	\\
%	Intermediate \textbf{\LaTeX}
%	&
